// Generated by gencpp from file lsd_slam_core/ThreeMap.msg
// DO NOT EDIT!


#ifndef LSD_SLAM_CORE_MESSAGE_THREEMAP_H
#define LSD_SLAM_CORE_MESSAGE_THREEMAP_H
...
struct ThreeMap_
{
  ...
  typedef boost::shared_ptr< ::lsd_slam_core::ThreeMap_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::lsd_slam_core::ThreeMap_<ContainerAllocator> const> ConstPtr;

}; // struct ThreeMap_

typedef ::lsd_slam_core::ThreeMap_<std::allocator<void> > ThreeMap;

typedef boost::shared_ptr< ::lsd_slam_core::ThreeMap > ThreeMapPtr;
typedef boost::shared_ptr< ::lsd_slam_core::ThreeMap const> ThreeMapConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::lsd_slam_core::ThreeMap_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::lsd_slam_core::ThreeMap_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::lsd_slam_core::ThreeMap_<ContainerAllocator1> & lhs, const ::lsd_slam_core::ThreeMap_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::lsd_slam_core::ThreeMap_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::lsd_slam_core::ThreeMap_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::lsd_slam_core::ThreeMap_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::lsd_slam_core::ThreeMap_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::lsd_slam_core::ThreeMap_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::lsd_slam_core::ThreeMap_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::lsd_slam_core::ThreeMap_<ContainerAllocator> >
{
  ...
  static const char* value(const ::lsd_slam_core::ThreeMap_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x35eb6653c31b68cbULL;
  static const uint64_t static_value2 = 0x2b3203e9acd1f9e4ULL;
};

template<class ContainerAllocator>
struct DataType< ::lsd_slam_core::ThreeMap_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::lsd_slam_core::ThreeMap_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::lsd_slam_core::ThreeMap_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::lsd_slam_core::ThreeMap_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::lsd_slam_core::ThreeMap_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // LSD_SLAM_CORE_MESSAGE_THREEMAP_H
