...
(cl:defmethod cl:initialize-instance :after ((m <NewMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NewMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lsd_slam_core-msg:<NewMsg> is deprecated: use lsd_slam_core-msg:NewMsg instead.")))
...
(cl:defmethod LSDMap-val ((m <NewMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lsd_slam_core-msg:LSDMap-val is deprecated.  Use lsd_slam_core-msg:LSDMap instead.")
  (LSDMap m))

(cl:ensure-generic-function 'depth-val :lambda-list '(m))
(cl:defmethod depth-val ((m <NewMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lsd_slam_core-msg:depth-val is deprecated.  Use lsd_slam_core-msg:depth instead.")
  (depth m))

(cl:ensure-generic-function 'scale-val :lambda-list '(m))
(cl:defmethod scale-val ((m <NewMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lsd_slam_core-msg:scale-val is deprecated.  Use lsd_slam_core-msg:scale instead.")
  (scale m))
