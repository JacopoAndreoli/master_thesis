...
(cl:defmethod cl:initialize-instance :after ((m <Idepth>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Idepth)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lsd_slam_core-msg:<Idepth> is deprecated: use lsd_slam_core-msg:Idepth instead.")))
...
(cl:defmethod idepth-val ((m <Idepth>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lsd_slam_core-msg:idepth-val is deprecated.  Use lsd_slam_core-msg:idepth instead.")
  (idepth m))
