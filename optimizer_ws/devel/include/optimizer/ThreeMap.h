// Generated by gencpp from file optimizer/ThreeMap.msg
// DO NOT EDIT!


#ifndef OPTIMIZER_MESSAGE_THREEMAP_H
#define OPTIMIZER_MESSAGE_THREEMAP_H
...
struct ThreeMap_
{
  ...
  typedef boost::shared_ptr< ::optimizer::ThreeMap_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::optimizer::ThreeMap_<ContainerAllocator> const> ConstPtr;

}; // struct ThreeMap_

typedef ::optimizer::ThreeMap_<std::allocator<void> > ThreeMap;

typedef boost::shared_ptr< ::optimizer::ThreeMap > ThreeMapPtr;
typedef boost::shared_ptr< ::optimizer::ThreeMap const> ThreeMapConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::optimizer::ThreeMap_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::optimizer::ThreeMap_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::optimizer::ThreeMap_<ContainerAllocator1> & lhs, const ::optimizer::ThreeMap_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::optimizer::ThreeMap_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::optimizer::ThreeMap_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::optimizer::ThreeMap_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::optimizer::ThreeMap_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::optimizer::ThreeMap_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::optimizer::ThreeMap_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::optimizer::ThreeMap_<ContainerAllocator> >
{
  ...
  static const char* value(const ::optimizer::ThreeMap_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x35eb6653c31b68cbULL;
  static const uint64_t static_value2 = 0x2b3203e9acd1f9e4ULL;
};

template<class ContainerAllocator>
struct DataType< ::optimizer::ThreeMap_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::optimizer::ThreeMap_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::optimizer::ThreeMap_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::optimizer::ThreeMap_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::optimizer::ThreeMap_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // OPTIMIZER_MESSAGE_THREEMAP_H
