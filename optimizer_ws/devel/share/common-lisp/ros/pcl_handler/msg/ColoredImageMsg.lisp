...
(cl:defmethod cl:initialize-instance :after ((m <ColoredImageMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ColoredImageMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pcl_handler-msg:<ColoredImageMsg> is deprecated: use pcl_handler-msg:ColoredImageMsg instead.")))
