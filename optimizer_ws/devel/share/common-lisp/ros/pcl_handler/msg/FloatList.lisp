...
(cl:defmethod cl:initialize-instance :after ((m <FloatList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FloatList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pcl_handler-msg:<FloatList> is deprecated: use pcl_handler-msg:FloatList instead.")))
...
(cl:defmethod elements-val ((m <FloatList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pcl_handler-msg:elements-val is deprecated.  Use pcl_handler-msg:elements instead.")
  (elements m))
