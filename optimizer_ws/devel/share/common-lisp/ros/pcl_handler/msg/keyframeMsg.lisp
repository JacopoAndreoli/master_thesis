...
(cl:defmethod cl:initialize-instance :after ((m <keyframeMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'keyframeMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pcl_handler-msg:<keyframeMsg> is deprecated: use pcl_handler-msg:keyframeMsg instead.")))
