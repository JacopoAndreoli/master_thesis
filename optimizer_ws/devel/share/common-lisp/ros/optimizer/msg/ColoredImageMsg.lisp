...
(cl:defmethod cl:initialize-instance :after ((m <ColoredImageMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ColoredImageMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name optimizer-msg:<ColoredImageMsg> is deprecated: use optimizer-msg:ColoredImageMsg instead.")))
