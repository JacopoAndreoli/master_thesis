...
(cl:defmethod cl:initialize-instance :after ((m <FloatArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FloatArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name optimizer-msg:<FloatArray> is deprecated: use optimizer-msg:FloatArray instead.")))
