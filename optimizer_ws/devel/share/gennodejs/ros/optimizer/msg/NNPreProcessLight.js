...
class NNPreProcessLight {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('headerScan')) {
        this.headerScan = initObj.headerScan
      }
      else {
        this.headerScan = new std_msgs.msg.Header();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [headerScan]
    bufferOffset = std_msgs.msg.Header.serialize(obj.headerScan, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [headerScan]
    data.headerScan = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += std_msgs.msg.Header.getMessageSize(object.headerScan);
  ...
  static Resolve(msg) {
    ...
    if (msg.headerScan !== undefined) {
      resolved.headerScan = std_msgs.msg.Header.Resolve(msg.headerScan)
    }
    else {
      resolved.headerScan = new std_msgs.msg.Header()
    }
