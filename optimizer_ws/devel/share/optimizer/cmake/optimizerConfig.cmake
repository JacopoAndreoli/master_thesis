...
if("TRUE" STREQUAL "TRUE")
  set(optimizer_SOURCE_PREFIX /home/jacopo/optimizer_ws/src/optimizer)
  set(optimizer_DEVEL_PREFIX /home/jacopo/optimizer_ws/devel)
  ...
  set(optimizer_INSTALL_PREFIX /home/jacopo/optimizer_ws/install)
...
if(NOT "/home/jacopo/optimizer_ws/devel/include;/home/jacopo/optimizer_ws/src/optimizer/include " STREQUAL " ")
  set(optimizer_INCLUDE_DIRS "")
  set(_include_dirs "/home/jacopo/optimizer_ws/devel/include;/home/jacopo/optimizer_ws/src/optimizer/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'optimizer' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jacopo/optimizer_ws/src/optimizer/${idir}'.  ${_report}")
    endif()
    _list_append_unique(optimizer_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "optimizer")
...
set(optimizer_EXPORTED_TARGETS "optimizer_generate_messages_cpp;optimizer_generate_messages_eus;optimizer_generate_messages_lisp;optimizer_generate_messages_nodejs;optimizer_generate_messages_py")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(optimizer_EXPORTED_TARGETS ${${optimizer_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "optimizer-msg-extras.cmake")
